 ...
 */
public class AtlasControllerTest extends BaseTest {
    ...
    public void setup() {
        ...
        this.mockMvc = MockMvcBuilders
                .standaloneSetup(AopTestUtils.getTargetObject(atlasController))
                .build();
    }
    ...
    public void testListByTag() throws Exception {
        String subType = "1";
        mockMvc.perform(get("/atlas/listByType/{subType}", subType))
                .andDo(print())
    ...
    public void testGetDetailById() throws Exception {
        String id = "1";
        mockMvc.perform(get("/atlas/detail/{id}", id))
                .andDo(print())
                .andExpect(status().isOk());
    }
