package com.chinaredstar.cms.config;
...
public class RedisHttpSessionConfiguration2 extends SpringHttpSessionConfiguration implements ImportAware {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
            @Qualifier("sessionJedisConnectionFactory") RedisConnectionFactory connectionFactory, RedisOperationsSessionRepository2 messageListener) {
    ...
    @Bean
    public RedisOperationsSessionRepository2 sessionRepository(@Qualifier("sessionRedisTemplate") RedisOperations<Object, Object> sessionRedisTemplate, ApplicationEventPublisher applicationEventPublisher) {
        RedisOperationsSessionRepository2 sessionRepository = new RedisOperationsSessionRepository2(sessionRedisTemplate);
